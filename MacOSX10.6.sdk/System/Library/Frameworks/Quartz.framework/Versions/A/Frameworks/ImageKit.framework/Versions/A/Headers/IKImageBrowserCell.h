...
/*! 
 ...
 @abstract Returns the receiver’s represented object.
 @discussion Subclasses should not override this method.
 */
- (id) representedItem;
...
/*! 
 ...
 @abstract Returns the index of the receiver’s represented object in the datasource.
 @discussion Subclasses should not override this method.
 */
...
/*! 
 @method frame
 @abstract Returns the receiver’s frame rectangle, which defines its position in its IKImageBrowserView.
...
/*! 
 ...
 @abstract Returns the receiver’s image container frame rectangle, which defines the position of the container of the thumbnail in its IKImageBrowserView.
...
/*! 
 @method imageFrame
 @abstract Returns the receiver’s image frame rectangle, which defines the position of the thumbnail in its IKImageBrowserView.
...
/*! 
 ...
 @abstract Returns the receiver’s selection frame rectangle, which defines the position of the selection rectangle in its IKImageBrowserView.
...
/*! 
 @method titleFrame
 @abstract Returns the receiver’s title frame rectangle, which defines the position of the title in its IKImageBrowserView.
...
/*! 
 ...
 @abstract Returns the receiver’s subtitle frame rectangle, which defines the position of the subtitle in its IKImageBrowserView.
...
/*! 
 ...
 @abstract Returns the position of the cell’s image in the frame. The default is NSImageAlignCenter.
...
/*! 
 ...
 @discussion Returns IKImageStateReady if the receiver’s represented object has been set and the cell is ready to display. The IKImageBrowserView creates thumbnails asynchronously; This method returns IKImageStateNoImage until a thumbnail has been created from the represented object. 
 */
...
/*! 
 @method layerForType:
 @abstract Provides the receiver’s layer for the given type. The default is nil.
