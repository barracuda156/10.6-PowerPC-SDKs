...
FOUNDATION_EXPORT NSString * const NSURLCreationDateKey                AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // NSDate
FOUNDATION_EXPORT NSString * const NSURLContentAccessDateKey           AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // NSDate
FOUNDATION_EXPORT NSString * const NSURLContentModificationDateKey     AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // NSDate
FOUNDATION_EXPORT NSString * const NSURLAttributeModificationDateKey   AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // NSDate
...
FOUNDATION_EXPORT NSString * const NSURLParentDirectoryURLKey          AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // Resource parent directory; NSURL
...
FOUNDATION_EXPORT NSString * const NSURLLabelColorKey                  AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // NSColor
FOUNDATION_EXPORT NSString * const NSURLLocalizedLabelKey              AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // Localized label text; NSString
...
FOUNDATION_EXPORT NSString * const NSURLCustomIconKey                  AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; // The icon image stored with the resource, if any; NSImage
