...
#ifndef QTCAPTUREFILEOUTPUT_H
#define QTCAPTUREFILEOUTPUT_H
...
/*!
    ...
    @discussion This method returns whether recording to the file returned by outputFileURL has been previous paused using the pauseRecording method.
...
/*!
    ...
    the captureOutput:didOutputSampleBuffer:fromConnection: delegate method to pause recording at an exact media sample.
*/
