...
#ifndef __NSOPENDIRECTORY_H
#define __NSOPENDIRECTORY_H
...
// If CFOpenDirectoryTypes.h has already been included, do not redefine the types
...
- (NSArray *)nodeNames:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
- (NSArray *)subnodeNames:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
- (NSArray *)unreachableSubnodeNames:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
- (NSArray *)supportedRecordTypes:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
- (BOOL)synchronize:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/*!
    ...
    @discussion Will take a mixture of NSData or NSString when setting the values of an attribute.  outError is optional 
                parameter, nil can be passed if error details are not needed.
*/
- (BOOL)setValues:(NSArray *)inValues forAttribute:(ODAttributeType)inAttribute error:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
...
- (BOOL)deleteRecord:(NSError **)outError DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
