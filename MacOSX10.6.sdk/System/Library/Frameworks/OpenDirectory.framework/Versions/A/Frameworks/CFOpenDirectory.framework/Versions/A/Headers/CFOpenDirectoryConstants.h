...
/* *********** DO NOT USE THESE THEY ARE ONLY TEMPORARY DURING TRANSITION TO API *************/
CF_EXPORT const uint32_t kODTypeAuthenticationSearchNode DEPRECATED_ATTRIBUTE;
CF_EXPORT const uint32_t kODTypeContactSearchNode DEPRECATED_ATTRIBUTE;
CF_EXPORT const uint32_t kODTypeNetworkSearchNode DEPRECATED_ATTRIBUTE;
CF_EXPORT const uint32_t kODTypeLocalNode DEPRECATED_ATTRIBUTE;
CF_EXPORT const uint32_t kODTypeConfigNode DEPRECATED_ATTRIBUTE;
