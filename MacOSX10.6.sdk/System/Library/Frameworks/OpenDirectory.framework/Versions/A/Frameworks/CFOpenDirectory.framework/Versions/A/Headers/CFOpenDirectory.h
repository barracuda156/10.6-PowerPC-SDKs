...
*/
CF_EXPORT
bool ODRecordSetValues( ODRecordRef inRecord, ODAttributeType inAttribute, CFArrayRef inValues, CFErrorRef *outError ) DEPRECATED_IN_MAC_OS_X_VERSION_10_6_AND_LATER;
