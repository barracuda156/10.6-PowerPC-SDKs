...
AudioUnitSetRenderNotification(		AudioUnit					ci,
									...
									void *						inProcRefCon)		__OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_1,__MAC_10_3, __IPHONE_NA, __IPHONE_NA);
...
AudioUnitRenderSlice(				AudioUnit					ci,
									...
									AudioBuffer *				ioData)				__OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0,__MAC_10_3, __IPHONE_NA, __IPHONE_NA);
