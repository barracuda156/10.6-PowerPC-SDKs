...
*/
APPKIT_EXTERN NSString *const NSAccessibilityHorizontialUnitsAttribute AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;   //(NSString *) - see ruler unit values below
...
APPKIT_EXTERN NSString *const NSAccessibilityHorizontialUnitDescriptionAttribute AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER; //(NSString *)
