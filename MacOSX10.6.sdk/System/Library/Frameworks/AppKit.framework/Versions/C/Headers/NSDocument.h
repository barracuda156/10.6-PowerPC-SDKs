...
/* Return YES to enable concurrent reading of documents of the given type.  When enabled, documents of the given type may be opened on background threads.  The default is NO.  In order to enable concurrent opening of documents, your document code must be thread-safe. */
+ (BOOL)canConcurrentlyReadDocumentsOfType:(NSString *)typeName AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
