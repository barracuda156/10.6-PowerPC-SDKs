...
#define round_page_32(x) (((uintptr_t)(x) + PAGE_MASK) & ~((uintptr_t)PAGE_MASK))
#define trunc_page_32(x) ((uintptr_t)(x) & ~((uintptr_t)PAGE_MASK))
 ...
 * so we limit the size of anonymous memory objects to 4GB minus 1 page.
