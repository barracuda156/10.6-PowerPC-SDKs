...
#define rUTXH0      (*(volatile unsigned char *)(uart_base + 0x20)) //UART 0 Transmission Hold
#define rURXH0      (*(volatile unsigned char *)(uart_base + 0x24)) //UART 0 Receive buffer
...
#define rUTXH1      (*(volatile unsigned char *)(uart1_base + 0x20)) //UART 1 Transmission Hold
#define rURXH1      (*(volatile unsigned char *)(uart1_base + 0x24)) //UART 1 Receive buffer
...
#define rUTXH2      (*(volatile unsigned char *)(uart2_base + 0x20)) //UART 2 Transmission Hold
#define rURXH2      (*(volatile unsigned char *)(uart2_base + 0x24)) //UART 2 Receive buffer
