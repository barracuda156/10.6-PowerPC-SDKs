...
public:
    ...
    */
	...
	@discussion This function copies this dictionary and all included collections recursively.  Objects that don't derive from OSContainer are NOT copied, that is objects like OSString and OSData.
