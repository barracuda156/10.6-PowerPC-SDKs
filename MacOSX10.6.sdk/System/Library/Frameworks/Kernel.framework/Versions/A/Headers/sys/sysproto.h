 ...
 * created from /SourceCache/xnu/xnu-1346.7/bsd/kern/syscalls.master
 */
...
struct fsctl_args {
	char path_l_[PADL_(user_addr_t)]; user_addr_t path; char path_r_[PADR_(user_addr_t)];
	char cmd_l_[PADL_(u_int)]; u_int cmd; char cmd_r_[PADR_(u_int)];
	char data_l_[PADL_(user_addr_t)]; user_addr_t data; char data_r_[PADR_(user_addr_t)];
...
struct bsdthread_register_args {
	...
	char threadstart_func2_l_[PADL_(user_addr_t)]; user_addr_t threadstart_func2; char threadstart_func2_r_[PADR_(user_addr_t)];
	char wqthread_func2_l_[PADL_(user_addr_t)]; user_addr_t wqthread_func2; char wqthread_func2_r_[PADR_(user_addr_t)];
};
