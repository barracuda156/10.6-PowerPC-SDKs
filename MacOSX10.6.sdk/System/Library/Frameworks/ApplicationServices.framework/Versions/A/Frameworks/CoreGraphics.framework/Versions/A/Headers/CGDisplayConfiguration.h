...
CG_EXTERN CGError CGBeginDisplayConfiguration(CGDisplayConfigRef *pConfigRef) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGConfigureDisplayStereoOperation(CGDisplayConfigRef configRef, CGDirectDisplayID display, boolean_t stereo, boolean_t forceBlueLine) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
...
CG_EXTERN CGError CGConfigureDisplayMirrorOfDisplay(CGDisplayConfigRef configRef,
                                                     CGDirectDisplayID display,
                                                     CGDirectDisplayID masterDisplay) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* Cancel a reconfiguration operation, discarding the configRef */
CG_EXTERN CGError CGCancelDisplayConfiguration(CGDisplayConfigRef configRef) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
...
CG_EXTERN CGError CGCompleteDisplayConfiguration( CGDisplayConfigRef configRef, CGConfigureOption option ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);

/* Restore the permanent display configuration from the user's display preferences settings */
CG_EXTERN void CGRestorePermanentDisplayConfiguration(void) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
...
CG_EXTERN CGError CGDisplayRegisterReconfigurationCallback(CGDisplayReconfigurationCallBack proc, void *userInfo) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);

CG_EXTERN CGError CGDisplayRemoveReconfigurationCallback(CGDisplayReconfigurationCallBack proc, void *userInfo) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
 ...
 * configuration always reverts to the permanent configuration setting.
 */
CG_EXTERN CGError CGDisplaySetStereoOperation(CGDirectDisplayID display, boolean_t stereo, boolean_t forceBlueLine, CGConfigureOption option) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
...
CG_EXTERN boolean_t CGDisplayIsActive(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is asleep and therefore not drawable */
CG_EXTERN boolean_t CGDisplayIsAsleep(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/*
 * True if the display is valid, with a monitor connected
 * (support for hot plugging of monitors)
 */
CG_EXTERN boolean_t CGDisplayIsOnline(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is the current main display */
CG_EXTERN boolean_t CGDisplayIsMain(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is built in, such as the internal display in portables */
CG_EXTERN boolean_t CGDisplayIsBuiltin(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is in a mirroring set */
CG_EXTERN boolean_t CGDisplayIsInMirrorSet(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is always in a mirroring set, and cannot be unmirrored */
CG_EXTERN boolean_t CGDisplayIsAlwaysInMirrorSet(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is in a hardware mirroring set */
CG_EXTERN boolean_t CGDisplayIsInHWMirrorSet(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* Returns display being mirrored, or kCGNullDirectDisplay if master or unmirrored */
CG_EXTERN CGDirectDisplayID CGDisplayMirrorsDisplay(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is using OpenGL acceleration */
CG_EXTERN boolean_t CGDisplayUsesOpenGLAcceleration(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* True if the display is running in a stereo graphics mode */
CG_EXTERN boolean_t CGDisplayIsStereo(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA); /* 10.4.3 and later - need a macro */

/*
 * Returns the display bound to the hardware accelerator in a HW mirror set,
 * or 'display' if software mirrored or unmirrored
 */
CG_EXTERN CGDirectDisplayID CGDisplayPrimaryDisplay(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/*
 * Returns the logical unit, vendor ID, vendor model number,
 * and serial number for a display
 */
CG_EXTERN uint32_t CGDisplayUnitNumber(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
CG_EXTERN uint32_t CGDisplayVendorNumber(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
CG_EXTERN uint32_t CGDisplayModelNumber(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
CG_EXTERN uint32_t CGDisplaySerialNumber(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/* Returns the IOKit service port for a display device */
CG_EXTERN io_service_t CGDisplayIOServicePort(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
 ...
 */
CG_EXTERN CGSize CGDisplayScreenSize(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
 ...
 */
CG_EXTERN double CGDisplayRotation(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);

/* Return a copy of the current color space of the specified display. */

CG_EXTERN CGColorSpaceRef CGDisplayCopyColorSpace(CGDirectDisplayID display) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
