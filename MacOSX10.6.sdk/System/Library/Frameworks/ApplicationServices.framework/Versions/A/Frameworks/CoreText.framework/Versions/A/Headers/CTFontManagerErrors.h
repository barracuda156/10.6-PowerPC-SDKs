...
/*!
    ...
    @discussion CFErrors with this domain will have error codes corresponding to one of the 
				CTFontManagerErrors above.
*/
extern const CFStringRef kCTFontManagerErrorDomain AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/*!
	@constant	kCTFontManagerErrorFontURLsKey
	@abstract	User info key to be used with CFError references returned from registrations API.
	@discussion	The value associated with this key in the user info dictionary of a CFError is a CFArray
				of font URLs that failed with given error.
 */
extern const CFStringRef kCTFontManagerErrorFontURLsKey AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/*!
    @enum 
    @abstract   Font registration errors
    @discussion Errors retuwould prevent registration of fonts for a specified font file URL.
