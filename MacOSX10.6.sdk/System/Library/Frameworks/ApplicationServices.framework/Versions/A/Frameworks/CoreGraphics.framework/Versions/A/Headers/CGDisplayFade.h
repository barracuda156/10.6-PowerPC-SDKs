...
/* API to fade displays to and from a solid color, without resorting to
 * playing with the gamma table APIs and losing ColorSync calibration.
 *
...
CG_EXTERN CGError CGConfigureDisplayFadeEffect(CGDisplayConfigRef configRef,
                                     ...
                                     float fadeRed,
                                     float fadeGreen,
                                     float fadeBlue) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
...
CG_EXTERN CGError CGAcquireDisplayFadeReservation(CGDisplayReservationInterval seconds,
                                        CGDisplayFadeReservationToken * pNewToken) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
 ...
 * and kCGErrorSuccess on success.
 */
CG_EXTERN CGError CGReleaseDisplayFadeReservation(CGDisplayFadeReservationToken myToken) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
...
CG_EXTERN CGError CGDisplayFade(CGDisplayFadeReservationToken myToken,
                      ...
                      boolean_t synchronous) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);

/*
 * Returns true if a fade operation is currently in progress.
 */
CG_EXTERN boolean_t CGDisplayFadeOperationInProgress(void) CG_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_NA);
