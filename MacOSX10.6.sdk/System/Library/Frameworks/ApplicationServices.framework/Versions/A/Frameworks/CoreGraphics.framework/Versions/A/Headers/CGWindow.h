...
CG_EXTERN const CFStringRef kCGWindowNumber CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowStoreType CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);

/*  Required: The value for this key is a CFNumberRef encoding with kCFNumberIntType
 * the window layer number */
CG_EXTERN const CFStringRef kCGWindowLayer CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowBounds CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowSharingState CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowAlpha CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);

/* Required: The value for this key is a CFNumberRef encoding as a kCFNumberIntType
 * the process ID that owns the window */
CG_EXTERN const CFStringRef kCGWindowOwnerPID CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowMemoryUsage CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowWorkspace CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);

/* Optional: The value for this key, if present, is a CFStringRef, set if an application name is registered */
CG_EXTERN const CFStringRef kCGWindowOwnerName CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowName CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowIsOnscreen CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN const CFStringRef kCGWindowBackingLocationVideoMemory CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN CFArrayRef CGWindowListCopyWindowInfo( CGWindowListOption option, CGWindowID relativeToWindow ) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
 ...
 *  Returns NULL if called from outside of a GUI security session, or if no window server is running
 *  The returned CFArray may be empty if no windows meet the specified criteria. */
CG_EXTERN CFArrayRef CGWindowListCreate( CGWindowListOption option, CGWindowID relativeToWindow ) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
 ...
 *  Returns NULL if called from outside of a GUI security session, or if no window server is running.
 */
CG_EXTERN CFArrayRef CGWindowListCreateDescriptionFromArray(CFArrayRef windowArray) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
...
CG_EXTERN CGImageRef CGWindowListCreateImage( CGRect screenBounds,
                                              ...
                                              CGWindowImageOption imageOption ) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
