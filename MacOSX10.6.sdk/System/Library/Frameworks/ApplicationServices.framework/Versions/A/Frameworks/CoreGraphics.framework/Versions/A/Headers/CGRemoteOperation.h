 ...
 */
CG_EXTERN CGError CGRegisterScreenRefreshCallback( CGScreenRefreshCallback function, void * userParameter ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN void CGUnregisterScreenRefreshCallback( CGScreenRefreshCallback function, void * userParameter ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGWaitForScreenRefreshRects( CGRect ** pRectArray, CGRectCount * pCount ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
/* End Old API */
 ...
 * userParameter is passed back with each invocation of the callback function.
 */
CG_EXTERN CGError CGScreenRegisterMoveCallback( CGScreenUpdateMoveCallback function, void * userParameter ) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);

/*
 * Remove a previously registered callback function.
 */
CG_EXTERN void CGScreenUnregisterMoveCallback( CGScreenUpdateMoveCallback function, void * userParameter ) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
...
CG_EXTERN CGError CGWaitForScreenUpdateRects( CGScreenUpdateOperation requestedOperations,
                                              ...
                                              CGRect ** pRectArray,
                                              size_t * pCount,
                                              CGScreenUpdateMoveDelta *pDelta ) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
/* End New API */
/*
 * Deallocate the list of rects recieved from CGWaitForScreenRefreshRects()
 */
CG_EXTERN void CGReleaseScreenRefreshRects( CGRect * rectArray ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN boolean_t CGCursorIsVisible(void) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
CG_EXTERN boolean_t CGCursorIsDrawnInFramebuffer(void) CG_AVAILABLE_STARTING(__MAC_10_3, __IPHONE_NA);
...
CG_EXTERN CGError CGPostMouseEvent( CGPoint mouseCursorPosition,
                                        ...
                                        boolean_t mouseButtonDown, ... ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
...
CG_EXTERN CGError CGPostScrollWheelEvent( CGWheelCount wheelCount,
                                            int32_t wheel1, ... ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
...
CG_EXTERN CGError CGPostKeyboardEvent( CGCharCode keyChar,
                                          ...
                                          boolean_t keyDown ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);

/*
 * Warp the mouse cursor to the desired position in global
 * coordinates without generating events
 */
CG_EXTERN CGError CGWarpMouseCursorPosition( CGPoint newCursorPosition ) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGInhibitLocalEvents( boolean_t doInhibit) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGSetLocalEventsSuppressionInterval(CFTimeInterval seconds) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGEnableEventStateCombining(boolean_t doCombineState) CG_AVAILABLE_STARTING(__MAC_10_1, __IPHONE_NA);
...
CGEventSuppressionState state) CG_AVAILABLE_STARTING(__MAC_10_1, __IPHONE_NA);
 ...
 */
CG_EXTERN CGError CGAssociateMouseAndMouseCursorPosition(boolean_t connected) CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_NA);
 ...
 */
CG_EXTERN CFMachPortRef CGWindowServerCFMachPort(void) CG_AVAILABLE_STARTING(__MAC_10_1, __IPHONE_NA);
