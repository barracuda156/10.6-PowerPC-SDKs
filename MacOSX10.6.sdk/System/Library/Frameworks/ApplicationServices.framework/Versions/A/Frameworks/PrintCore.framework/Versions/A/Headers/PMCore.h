...
*    "printer-state", "printer-state-change-time",
*    "printer-state-message", and "printer-state-reasons" values for a
*    print queue.  These attributes are defined in the "CUPS
*    Implementation of IPP" specification at:
*
