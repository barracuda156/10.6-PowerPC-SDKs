...
CG_EXTERN CFTypeID CGEventSourceGetTypeID(void) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 */
CG_EXTERN CGEventSourceRef CGEventSourceCreate(CGEventSourceStateID sourceState) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 */
CG_EXTERN CGEventSourceKeyboardType CGEventSourceGetKeyboardType(CGEventSourceRef source) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
CG_EXTERN void CGEventSourceSetKeyboardType(CGEventSourceRef source, CGEventSourceKeyboardType keyboardType) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 */
CG_EXTERN void CGEventSourceSetPixelsPerLine( CGEventSourceRef source, double pixelsPerLine ) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
CG_EXTERN double CGEventSourceGetPixelsPerLine( CGEventSourceRef source ) CG_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_NA);
 ...
 * new events from this source.
 */
CG_EXTERN CGEventSourceStateID CGEventSourceGetSourceStateID(CGEventSourceRef source) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);

/*
 * The state of an event source may be queried for specialized event processing
 * purposes.
 */
CG_EXTERN bool CGEventSourceButtonState( CGEventSourceStateID sourceState, CGMouseButton button )  CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
CG_EXTERN bool CGEventSourceKeyState( CGEventSourceStateID sourceState, CGKeyCode key )  CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
CG_EXTERN CGEventFlags CGEventSourceFlagsState( CGEventSourceStateID sourceState )  CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
...
CG_EXTERN CFTimeInterval CGEventSourceSecondsSinceLastEventType( CGEventSourceStateID source, CGEventType eventType )  CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 *
 */
CG_EXTERN uint32_t CGEventSourceCounterForEventType(CGEventSourceStateID source, CGEventType evType) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 */
CG_EXTERN void CGEventSourceSetUserData(CGEventSourceRef source, int64_t userData) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
CG_EXTERN int64_t CGEventSourceGetUserData(CGEventSourceRef source) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
...
CG_EXTERN void CGEventSourceSetLocalEventsFilterDuringSuppressionState(CGEventSourceRef source,
                                                                       ...
                                                                       CGEventSuppressionState state) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
 ...
 */
CG_EXTERN void CGEventSourceSetLocalEventsSuppressionInterval(CGEventSourceRef source, CFTimeInterval seconds) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
CG_EXTERN CFTimeInterval CGEventSourceGetLocalEventsSuppressionInterval(CGEventSourceRef source) CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_NA);
