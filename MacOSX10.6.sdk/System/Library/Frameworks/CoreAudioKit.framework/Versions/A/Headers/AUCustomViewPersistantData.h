@protocol AUCustomViewPersistantData

/*!
	@header AUCustomViewPersistantData
...
/*!
	@function	customViewPersistantData
...
*/
- (NSDictionary *)customViewPersistantData;

/*!
	@function	setCustomViewPersistantData:
...
*/
- (void) setCustomViewPersistantData:(NSDictionary *) data;
