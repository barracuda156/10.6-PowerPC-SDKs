...
enum
{
    ...
    kAudioChannelLayoutTag_StereoHeadphones         = (102<<16) | 2,   // a standard stereo stream (L R) - implied headphone playbac
    ...
    kAudioChannelLayoutTag_Quadraphonic             = (108<<16) | 4,   // front left, front right, back left, back right

    kAudioChannelLayoutTag_Pentagonal               = (109<<16) | 5,   // left, right, rear left, rear right, center

    kAudioChannelLayoutTag_Hexagonal                = (110<<16) | 6,   // left, right, rear left, rear right, center, rear

    kAudioChannelLayoutTag_Octagonal                = (111<<16) | 8,   // front left, front right, rear left, rear right,
