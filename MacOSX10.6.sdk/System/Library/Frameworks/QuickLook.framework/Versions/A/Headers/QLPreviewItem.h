...
/*!
 * @abstract The QLPreviewItem protocol declares the methods that a QLPreviewPanel or a QLPreviewView instance uses to access the contents of a given item.
 */
