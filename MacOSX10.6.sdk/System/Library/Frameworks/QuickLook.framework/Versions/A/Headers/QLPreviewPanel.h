 ...
 *      gets its content or can use regular bindings. QLPreviewPanel also can have a delegate.
 */
 ...
 */
@property NSUInteger currentPreviewItemIndex;
 ...
 */
- (NSUInteger)numberOfPreviewItemsInPreviewPanel:(QLPreviewPanel *)panel;
 ...
 */
- (id <QLPreviewItem>)previewPanel:(QLPreviewPanel *)panel previewItemAtIndex:(NSUInteger)index;
